  ...
  return (
    <section className='lhero'>
      <div className='lhero-data'>
        ...
        <p className='text'>Te enseñamos a travez de cursos o sesiones en vivo las estrategias de inversión mas efectivas en el mercado de Forex, bolsa de valores, criptomonedas o índices. Genera una nueva fuente de ingresos, aprende la información que te dará mas libertad.</p>
