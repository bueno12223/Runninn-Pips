...
function testimonial () {
  const testimonialData = [
    ...
    { img: OmarImg, desc: 'CEO de Running Trader', title: 'Omar Sosa', text: 'Antes era mecanico naval, no me faltaba dinero pero si tiempo para estar con mi familia, cuando empezé con el trading perdí demasiado dinero pero mucho tiempo después, luego de aprender la información correcta, soy libre de mi trabajo y ahora me dedico a cambiar vidas a través de mi conocimiento en lo mercados financieros.' },
